...
function App() {
  ...
  return (
    <>
      ...
      <h1 className='font-bold text-center text-3xl'>ToDoList App - Your Task Planner</h1>
        <div className="addTodo my-5 flex flex-col gap-3">
          ...
          <button onClick={handleAdd} className='bg-green-600 hover:bg-green-700 p-2 font-bold text-sm text-white rounded-full disabled:bg-green-500 mx-2 w-1/4' disabled={todo.length<1} >Add Todo</button>
          </div>
        </div>
